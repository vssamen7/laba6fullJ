// main.c
// Задание 1:Создать очередь для символов. Максимальный размер очереди вводится с экрана. Создать
// функции для ввода и вывода элементов очереди. Вводить символы с экрана в очередь. После введения
// 3-го символа в ответ на каждый вводимый выводить крайний левый символ.
// Заданрие 2: Создать дек для символов. Максимальный размер дека вводится с экрана. Создать функции
// для ввода и вывода элементов дека. Вводить элементы в дек поочередно справа и слева. При этом в
// ответ на добавление элемента с противоположной стороны дека один элемент удаляется.
// Задание 3: Создайте строку. Организовывая очереди по N элементов, создайте строки по N символов в
// каждой. Решение в программе оформляйте через подпрограммы.
// Алейник Иван 12.05.2025
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
